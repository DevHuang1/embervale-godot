...
func set_magic_level(v: float) -> void:
	_magic_level = clampf(v, 0.0, 1.0)
	RenderingServer.global_shader_parameter_set("world_magic_level", _magic_level)
